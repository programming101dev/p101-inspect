...
`p101-report -m`. The log contract is documented in
[`docs/event-format.md`](docs/event-format.md). The event log also has a
teaching exercise in [`docs/event-log-assignment.md`](docs/event-log-assignment.md),
and future timestamp support is sketched in
